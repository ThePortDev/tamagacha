...
class PetUserDefaults {
    ...
    init() {
        ...
        self.pet = Pet(name: "Steve", lastMeal: Date(), lastDrink: Date(), lastShower: Date(), lastShownAffection: Date(), petType: .dog, maxHunger: 100, maxThirst: 100, maxHygiene: 100, maxLove: 100)
    }
